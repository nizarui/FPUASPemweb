            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 container-fluid">
                        <h1 class="h3 mb-0 text-gray-800">Perusahaan A</h1>
                        <a href="excella.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                    </div>
                    ...
                    <script>
                        ...
                        // Query untuk mengambil data dari tabel tb_perusahaan_a
                        $query = "SELECT * FROM tb_perusahaan_a";
...
<script>
    ...
    xhr.open('GET', 'prosesperusahaana.php', true);
    xhr.send();
</script>
...
<script>
    ...
    xhr2.open('GET', 'prosesperusahaana.php', true);
    xhr2.send();
</script>