...
<body>
    ...
    <section style="margin: 10px">
        <h2 class="text-center">Galeri Rental Perusahaan B</h2>
        <div class="container">
            <div class="card">
    ...
    <section id="satusatu">
        <div class="border border-secondary">
            ...
            <form action="simpanclosingb.php" method="post" style="margin: 50px;">
                <div class="row">
                    <div class="col-xl-3">
                        <h5>Pilih Mobil</h5>
                    </div>
                ...
                <br>
                <button type="submit" id="nextb" name="nextb" class="btn btn-primary">Next</button>
            </form>
        </div>
    </section>
