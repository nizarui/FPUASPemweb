            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="excelldashboard.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                    </div>
                    ...
                    <script>
                        ...
                        $query = "SELECT * FROM tb_dashboard";
...
<script>
    ...
    xhr.open('GET', 'processdashboard.php', true);
    xhr.send();
</script>
...
<script>
    ...
    xhr2.open('GET', 'processdashboard.php', true);
    xhr2.send();
</script>
