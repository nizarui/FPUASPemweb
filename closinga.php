...
<body>
    ...
    <section style="margin: 10px">
        <h2 class="text-center">Galeri Rental Perusahaan A</h2>
        <div class="container">
            <div class="card">
                <img class="card-img-top" src="img/avanza.jpeg" alt="Card image cap">
                <div class="card-body">
                    <h3>Avanza</h3>
                    <p class="card-text text-muted">200 rb / hari</p>
                </div>
            </div>
            <div class="card">
    ...
    <section id="satusatu">
        <div class="border border-secondary">
            ...
            <form action="simpanclosinga.php" method="post" style="margin: 50px;">
                <div class="row">
                    <div class="col-xl-3">
                        <h5>Pilih Mobil</h5>
                    </div>
                ...
                <br>
                <button type="submit" id="nexta" name="nexta" class="btn btn-primary">Next</button>
            </form>
        </div>
    </section>
