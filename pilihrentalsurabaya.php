                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card-body" style="margin-left: 10px;">
                                <h4 class="card-title">Perusahaan A Rental</h4>
                        ...
                        <div class="col-md-6 d-flex align-items-end justify-content-end">
                            <a href="closinga.php" class="btn btn-primary" style="margin-bottom: 10px; margin-right: 10px;">Pilih</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="card shadow">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card-body" style="margin-left: 10px;">
                                <h4 class="card-title">Perusahaan B Rental</h4>
                                <p class="card-text text-dark">&#128077; 8.5 / 10.0</p>
                                <p class="card-text text-dark">Yang Disukai Traveller :</p>
                                <p class="card-text text-muted">Kemudahan proses pengambilan dan pengembalian mobil</p>
                                <p class="card-text text-muted">Kebersihan Mobil</p>
                        ...
                        <div class="col-md-6 d-flex align-items-end justify-content-end">
                            <a href="closingb.php" class="btn btn-primary" style="margin-bottom: 10px; margin-right: 10px;">Pilih</a>
                        </div>
                    </div>
                </div>
            </div>
