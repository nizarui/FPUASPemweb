...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="perusahaana.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Perusahaan A</span></a>
            </li>

            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="perusahaanb.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Perusahaan B</span></a>
            </li>

            <!-- Nav Item - Charts -->
            <li class="nav-item active">
                <a class="nav-link" href="perusahaanc.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Perusahaan C</span></a>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 container-fluid">
                        <h1 class="h3 mb-0 text-gray-800">Perusahaan C</h1>
                        <a href="excellc.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                    </div>
                    ...
                    <script>
                        ...
                        // Query untuk mengambil data dari tabel tb_perusahaan_c
                        $query = "SELECT * FROM tb_perusahaan_c";
...
<script>
    ...
    xhr.open('GET', 'prosesperusahaanc.php', true);
    xhr.send();
</script>
...
<script>
    ...
    xhr2.open('GET', 'prosesperusahaanc.php', true);
    xhr2.send();
</script>